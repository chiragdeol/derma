            ...
            {servicesOpen && (
              ...
              >
                <div className="grid grid-cols-[1.1fr_1.1fr_0.9fr]">
                  ...
                  {/* Feature Panel */}
                  <div className="bg-[#e3dec9] p-8 flex flex-col justify-between relative overflow-hidden">
                    <div className="absolute inset-4 border border-[#974d08]/15 pointer-events-none rounded-lg" />
                    <div className="relative z-10">
                      <p className="eyebrow text-[#974d08] mb-2 font-medium">Not sure where to start?</p>
                      <h4 className="font-display text-xl text-foreground font-semibold mb-3">Book a consultation</h4>
