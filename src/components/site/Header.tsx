              ...
              >
                <div className="grid grid-cols-[1.1fr_1.1fr_0.9fr]">
                  ...
                  <div className="bg-forest p-8 flex flex-col justify-between text-ivory relative overflow-hidden">
                    <div className="absolute inset-4 border border-[#7B8D6A]/30 pointer-events-none rounded-lg" />
                    <div className="relative z-10">
                      <p className="eyebrow text-[#7B8D6A] mb-2">Not sure where to start?</p>
                    ...
                    <a
                      ...
                      rel="noreferrer"
                      onClick={() => setServicesOpen(false)}
                      className="relative z-10 w-full text-center rounded-lg bg-[#7B8D6A] border border-[#7B8D6A] hover:bg-transparent hover:text-[#7B8D6A] py-3 text-xs font-semibold text-white transition-all flex items-center justify-center gap-1.5 shadow-sm mt-8"
                    >
                      WhatsApp us
                    </a>
                  </div>
