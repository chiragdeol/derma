...
import doctorMenna from "@/assets/doctor-menna.png";
import doctorFatma from "@/assets/doctor-fatma.png";
...
import baDental5 from "@/assets/ba-dental-5.jpg";
...
const doctors = [
  ...
  },
  {
    ...
    specialties: [
      ...
      "Botox treatments (specially Migraine Botox)",
  ...
  },
  {
    ...
    specialties: [
      "Acne and acne scar treatments",
      "Hyperpigmentation and uneven skin tone management",
      "Diagnosis and treatment of general skin conditions",
      "Scar management and skin repair",
      "Hair-loss and scalp treatments",
      "Nail condition diagnosis and treatment",
