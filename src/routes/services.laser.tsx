...
export const Route = createFileRoute("/services/laser")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Advanced laser in Sharjah — hair removal safe on dark skin, plus pigmentation, vascular and tattoo removal. Book a patch test at Al Nemah." },
  ...
  component: () => (
    <ServiceTemplate
      ...
      metaDesc="Advanced laser in Sharjah — hair removal safe on dark skin, plus pigmentation, vascular and tattoo removal. Book a patch test at Al Nemah."
